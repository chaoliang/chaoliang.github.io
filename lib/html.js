...
<header class="site-header">
  <nav aria-label="Main navigation" class="site-nav">
    ...
    <div class="nav-links">
      ...
      <a href="/days-between/">Days between</a>
...
<footer class="site-footer">
  <div class="footer-grid">
    <div>
      ...
      <p class="footer-note">Also from us: <a href="https://mileagesum.com/">MileageSum</a> — IRS mileage
      reimbursement, computed exactly for any distance.</p>
    </div>
